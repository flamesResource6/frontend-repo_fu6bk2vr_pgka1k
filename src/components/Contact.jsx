...
export default function Contact() {
  return (
    <section id="contact" className="relative overflow-hidden bg-slate-950 py-24">
      <div className="absolute inset-0 bg-[radial-gradient(900px_300px_at_0%_20%,rgba(37,99,235,0.12),transparent),radial-gradient(700px_300px_at_100%_80%,rgba(14,165,233,0.1),transparent)]" />
      <div className="relative mx-auto max-w-4xl px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-white tracking-tight">Let's build something great</h2>
          <p className="mt-3 text-slate-400">Tell me about your project, timeline, and goals.</p>
        </div>
        ...
        >
          ...
          <div className="mt-6 flex items-center justify-between">
            ...
            <button className="inline-flex items-center justify-center rounded-lg bg-blue-600 px-5 py-3 text-white font-semibold shadow-[0_8px_30px_rgb(59,130,246,0.35)] hover:shadow-[0_8px_40px_rgb(59,130,246,0.55)] transition-shadow">
              Send Message
            </button>
          </div>
        </motion.form>
